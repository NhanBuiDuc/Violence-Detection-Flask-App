...
parser.add_argument('--step_size', default=25, help='The number of frames to step before extracting the next features.')
parser.add_argument('--stack_size', default=25, help='The number of frames from which to extract features (or window size).')
